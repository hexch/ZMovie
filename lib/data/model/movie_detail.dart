...
class MovieDetail with _$MovieDetail {
  ...
  factory MovieDetail({
    ...
    // @JsonKey(name: 'production_companies') double? productionCompanies,
    // @JsonKey(name: 'production_countries') double? productionCountries,
    @JsonKey(name: 'release_date') String? releaseDate,
    @JsonKey(name: 'revenue') int? revenue,
    @JsonKey(name: 'runtime') int? runtime,
    @JsonKey(name: 'spoken_languages') List<ApiConfigLanguage>? spokenLanguages,
